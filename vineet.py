...
def main():
  ...
  if choice == "EDA":
    ...
    if data is not None:
      ...
      test = [
          [name, years, km_driven, fuel, seller_type, transmission, owner]
      ]
      ...
      if st.button("Predict", key="int"):
        ...
        # Download the pipeline_model.pkl file from Google Drive
        url = "https://drive.google.com/file/d/1VrEWazQnvJSO8IeY5TYebsYTiXNIgiaJ/view?usp=drive_link"
        output = "pipeline_model.pkl"
